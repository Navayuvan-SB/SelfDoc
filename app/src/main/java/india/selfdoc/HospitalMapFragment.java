...
public class HospitalMapFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private String TAG = HospitalMapFragment.class.getSimpleName();
    private Button btnApply;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.hosmap_frag, null, false);
        SupportMapFragment mapFragment = (SupportMapFragment) this.getChildFragmentManager()
                .findFragmentById(R.id.hosmap);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(getActivity(), "These are your Nearby Hospitals! ",
